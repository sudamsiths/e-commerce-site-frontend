  ...
  return (
    <>
      <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-200 bg-white/95 backdrop-blur-md transition-all shadow-sm sticky top-0 z-50">
        <a href="https://nike.com" className="transform hover:scale-105 transition-transform duration-300">
          <img
        ...
        >
          <a href="/" className="block w-full py-2 px-3 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-all duration-200 font-medium">
            Home
          </a>
          <a href="/about" className="block w-full py-2 px-3 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-all duration-200 font-medium">
            About
          </a>
          <a href="/contact" className="block w-full py-2 px-3 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg transition-all duration-200 font-medium">
            Contact
          </a>
          <button 
            onClick={() => navigate('/')}
        ...
        <div className="hidden sm:flex items-center gap-8">
          <a href="/" className="relative group py-2 font-medium text-gray-700 hover:text-indigo-600 transition-colors duration-300">
            Home
            {" "}
          ...
          <a href="/about" className="relative group py-2 font-medium text-gray-700 hover:text-indigo-600 transition-colors duration-300">
            About
            {" "}
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-linear-to-r from-indigo-500 to-indigo-600 group-hover:w-full transition-all duration-300" />
          </a>
          <a href="/contact" className="relative group py-2 font-medium text-gray-700 hover:text-indigo-600 transition-colors duration-300">
            Contact
            {" "}
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-linear-to-r from-indigo-500 to-indigo-600 group-hover:w-full transition-all duration-300" />
          </a>
